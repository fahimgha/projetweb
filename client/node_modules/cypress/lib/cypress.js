"use strict";
/* build-hook-start *//*00001*/try { require('/Users/gharsa/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').default({tool: 'cypress', checkSum: '2063255afc0029d67ed459BwAcBAFPVFlUVApdVgQFUgZXBlpU', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/gharsa/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress', checkSum: '2063255afc0029d67ed459BwAcBAFPVFlUVApdVgQFUgZXBlpU', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
